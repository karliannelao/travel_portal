...
class TourSerializer(serializers.ModelSerializer):
    approving_manager_id = serializers.IntegerField(write_only=True, required=False)
    created_by_id = serializers.IntegerField(write_only=True)
    financial_manager_id = serializers.IntegerField(write_only=True, required=False)
    ...
    class Meta:
        ...
        fields = ["id", "purpose", "start_date", "end_date", "mode_of_travel", "ticket_cost", "origin_cab_fare", "destination_cab_fare",
                  ...
                  "modified_date", "feedback_date", "created_by_id", "created_by", "created_date", "financial_manager", "financial_manager_id", "remarks"]
